...
2. Define the testing strategy before writing the plan:
   ...
   - Playwright e2e specs under `e2e/*.spec.ts` for browser flows, and 375px/1440px screenshot capture for graded responsive checks (if the feature has UI impact)
